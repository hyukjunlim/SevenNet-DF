...
import sevenn_dfs.train.dataload as dataload
import sevenn_dfs.util as util
from sevenn_dfs import __version__
from sevenn_dfs._const import NUM_UNIV_ELEMENT
from sevenn_dfs.atom_graph_data import AtomGraphData
from sevenn_dfs.sevenn_logger import Logger
...
class SevenNetGraphDataset(InMemoryDataset):
    ...
    def _read_sevenn_data(filename: str) -> tuple[list[AtomGraphData], float]:
        ...
        from sevenn_dfs.train.dataset import AtomGraphDataset
